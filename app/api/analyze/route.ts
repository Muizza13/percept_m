      ...
      contents: [
        ...
        },
        {
          text: [
            ...
            "First, identify each distinct colored content block on the slide from top to bottom, starting at index 0.",
            "For each block, populate the blocks array with its index, its color (a short name or hex like \"blue\" or \"#c9d6ea\"), and a one-line summary of what it contains.",
            "Then, for every recommendation, set targetBlock to the index of the block it applies to, or -1 if the recommendation applies to the whole slide rather than a single block.",
